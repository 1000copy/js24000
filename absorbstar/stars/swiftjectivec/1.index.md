...
但是，相对于它们在平台上的无处不在，以高性能和节省内存的方式来展示它们的行为很容易变成管理不善的努力。 稍微了解 UIKit 内部发生的事情，以及这样处理图像的原因，大家可以获得一些巨大的资源节约，并放弃jetsam的无情愤怒。forgo the unrelenting wrath of jetsam[TODO]
