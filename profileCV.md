...
## 2019/11 - 至今 润光软件公司-联合创始人-CTO

以半年时间内，通过4个快速迭代，完成设备监控软件从零到一的研发并投入海外市场。

期间从头搭建光网络设备监控管理软件框架，建立研发团队，使用snmp，cli接口完成对华为中兴芯德设备调监控管理，使用nodejs+vuejs+mysql技术栈，充分利用graphql搭建接口机制。
